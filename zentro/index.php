		...
		<div class="navbar-header">
			<button class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
				...
				<span class="icon icon-bar"></span>
                    ...
                    <a href="index.php" class="navbar-brand">ZENTRO</a>
		</div>
                ...
                if (mysqli_num_rows($result))//3
                 {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<div class='col-md-4 col-sm-4 wow fadeInUp' data-wow-delay='0.3s'>";
                        echo "<a href='images/gallery-img1.jpg' data-lightbox-gallery='zenda-gallery'><img src='".$row['img']."' alt='gallery img'></a>";
                        echo "<div>";
                        echo "<h3>".$row['name']."</h3>";
